...
import { TranslationDict } from './src/i18n/translations.ts';
import { DraftLogo } from './src/components/DraftLogo.tsx';
import { OsintTerminal } from './src/components/ui/OsintTerminal.tsx';
import { Hero3D } from './src/components/ui/Hero3D.tsx';
import { FounderShowcase } from './src/components/sections/FounderShowcase.tsx';
import { PortfolioShowcase } from './src/components/sections/PortfolioShowcase.tsx';
...
export const DraftStudio: React.FC<DraftStudioProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100000] bg-zinc-950 text-white overflow-y-auto scroll-smooth custom-scrollbar isolate">
      ...
      {/* Main Page Content */}
      <div ref={containerRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-36 py-16 relative">
