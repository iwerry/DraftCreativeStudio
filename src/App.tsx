...
const SKILLS = [
  ...
  { role: "Design para Web", desc: "Layouts imersivos, responsivos e velozes, pensados especificamente para guiar o cliente à conversão.", bgImage: "https://picsum.photos/seed/web/800/600" },
    ...
    <div className="min-h-screen selection:bg-brand selection:text-paper font-sans">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-paper/90 backdrop-blur-md border-b border-brand/20 py-4' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            <button className="border border-brand text-brand hover:bg-brand hover:text-paper px-6 py-2 font-bold uppercase text-xs transition-all shadow-[0_0_15px_rgba(0,240,255,0.4)] hover:shadow-[0_0_25px_rgba(0,240,255,0.8)]">
              Vamos Conversar
            </button>
          </div>
      ...
      <footer className="py-12 px-6 border-t border-ink/20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <p className="text-ink/40 text-xs text-center md:text-left">© 2026 Draft Creative Studio. Desenvolvido com Antigravity.</p>
